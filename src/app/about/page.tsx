    ...
    <main className="pt-16 pb-24 px-6 md:px-12 max-w-7xl mx-auto space-y-24">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        <div className="md:col-span-7 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-container-high border border-outline-variant rounded-full text-primary text-xs font-medium tracking-wide">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter leading-none text-on-surface">
            ...
            <span className="text-secondary">layer by layer.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            <span className="px-4 py-1.5 bg-surface-container border border-outline-variant rounded text-sm text-secondary-fixed">Java</span>
            <span className="px-4 py-1.5 bg-surface-container border border-outline-variant rounded text-sm text-secondary-fixed">Python</span>
            <span className="px-4 py-1.5 bg-surface-container border border-outline-variant rounded text-sm text-secondary-fixed">C++</span>
            <span className="px-4 py-1.5 bg-surface-container border border-outline-variant rounded text-sm text-secondary-fixed">Node.js</span>
            <span className="px-4 py-1.5 bg-surface-container border border-outline-variant rounded text-sm text-secondary-fixed">Embedded Systems</span>
          </div>
        </div>
        <div className="md:col-span-5 relative group">
          <div className="absolute -inset-1 bg-gradient-to-tr from-primary/20 to-tertiary/20 rounded-xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
