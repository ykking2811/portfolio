...
export default function Contact() {
  return (
    <main className="pt-16 pb-24 px-6 md:px-12 max-w-7xl mx-auto min-h-[80vh]">
      {/* Hero Section */}
      <section className="mb-20">
        <h1 className="text-5xl md:text-7xl font-headline font-bold tracking-tighter text-on-surface mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        {/* Email Card */}
        <div className="md:col-span-8 group relative overflow-hidden bg-surface-container border border-outline-variant rounded-xl p-8 flex flex-col justify-between hover:border-primary transition-colors duration-300">
          <div className="z-10">
            <span className="material-symbols-outlined text-primary mb-4 block" style={{ fontSize: "40px" }}>mail</span>
          ...
          <div className="flex items-center justify-between z-10">
            <a className="text-xl md:text-3xl font-mono text-on-surface tracking-tight break-all" href="mailto:kulkarnis.yashodhan@gmail.com">
        ...
        {/* LinkedIn Card */}
        <a 
          className="md:col-span-4 group bg-surface-container border border-outline-variant rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-primary transition-all duration-300" 
          href="https://www.linkedin.com/in/yashodhan-k-55ab15229/" 
          target="_blank" 
          rel="noopener noreferrer"
        >
          <span className="material-symbols-outlined text-primary mb-6" style={{ fontSize: "48px", fontVariationSettings: "'FILL' 1" }}>share</span>
        ...
        <div className="md:col-span-8 h-80 bg-surface-container border border-outline-variant rounded-xl overflow-hidden relative">
          <img 
      ...
      <section className="mt-24 pt-24 border-t border-outline-variant text-center">
        ...
        <a 
          className="inline-flex items-center gap-4 bg-on-surface text-background px-10 py-5 rounded-lg text-xl font-bold hover:bg-primary transition-colors group" 
